...
public class ApplyChangeToTextDocument {
	...
	public void apply(Change change, TextDocument doc) {
		...
		case INSERT_TEXT:
			...
			//System.out.println("c:" + change.getText());
			//System.out.println("cr:" + change.getStartRow());
			//System.out.println("cc:" + change.getStartColumn());
...
//			}
		...
		case STUB_TEXT:
			for (int i = 0; i < change.getNumLines(); i++) {
				doc.insertLine(2 + i, change.getLine(i) + "\n");
			}
			break;	
		default:
