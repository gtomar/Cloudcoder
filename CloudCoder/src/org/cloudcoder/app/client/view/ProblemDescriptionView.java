...
public class ProblemDescriptionView extends ResizeComposite implements SessionObserver, Subscriber {
	...
	public ProblemDescriptionView() {
		...
		//HTML iframe = new HTML("<iframe width=\"" + "450" + "\" height=\"" + "700" + "\" frameborder=\"0\"" +
		//		" src=\"http://conversation.lti.cs.cmu.edu:8000/chat/user_study/" + username +"\"></iframe>", true);
		HTML iframe = new HTML("");
		dialogChatHtml = iframe;
		layoutPanel.add(dialogChatHtml);
		//problemDescriptionHtml.setStyleName("cc-problemDescription");
		layoutPanel.setWidgetLeftRight(dialogChatHtml, 0.0, Unit.PX, 0.0, Unit.PX);
		layoutPanel.setWidgetTopBottom(dialogChatHtml, 0.0, Unit.PX, 0.0, Unit.PX);
	...
	public ProblemDescriptionView(Boolean isDescription) {
		LayoutPanel layoutPanel = new LayoutPanel();
	...
	public void activate(Session session, SubscriptionRegistrar subscriptionRegistrar) {
		...
		if (problem != null) {
			...
			//HTML iframe = new HTML("<iframe width=\"" + "450" + "\" height=\"" + "500" + "\" frameborder=\"0\"" +
			//		" src=\"http://conversation.lti.cs.cmu.edu:8000/chat/userstudy/" + username +"\"></iframe>", true);
			HTML iframe = new HTML("<iframe width=\"" + "500" + "\" height=\"" + "600" + "\" frameborder=\"0\"" +
					" src=\"http://erebor.lti.cs.cmu.edu:8015/chat/" + userID + "/" + userID + "/" + username +"\"></iframe>", true);
			dialogChatHtml.setHTML(iframe.toString());
		}
	}
